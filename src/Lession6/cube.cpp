...
bool init_resources() {
	...
	SDL_Surface* res_texture = IMG_Load("/home/marc/Projects/openGL2/src/Lession6/res_texture.png");
	if (res_texture == NULL) {
	...
	GLuint vs, fs;
	if ((vs = create_shader("/home/marc/Projects/openGL2/src/Lession6/cube.v.glsl", GL_VERTEX_SHADER))   == 0) return false;
	if ((fs = create_shader("/home/marc/Projects/openGL2/src/Lession6/cube.f.glsl", GL_FRAGMENT_SHADER)) == 0) return false;
